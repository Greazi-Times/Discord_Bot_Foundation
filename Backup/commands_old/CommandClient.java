 ...
 * 
 * <p>This is implemented in {@link com.greazi.discordbotfoundation.commands.impl.CommandClientImpl CommandClientImpl}
 ...
 *     <li>The {@link com.greazi.discordbotfoundation.commands.CommandListener CommandListener} may be set.</li>
 * </ul>
 *
 * 
 * @implNote
 ...
 *
 *         <p><b>4)</b> Do not provide strings when using {@link com.greazi.discordbotfoundation.commands.CommandClientBuilder#setEmojis(String, String, String)
 ...
 *
 *         <p><b>5)</b> Avoid using {@link com.greazi.discordbotfoundation.commands.impl.CommandClientImpl#linkIds(long,
...
public interface CommandClient
{
     ...
     * 
     * <p>This is the same as {@link com.greazi.discordbotfoundation.commands.CommandClient#getPrefix() } unless the prefix is the default,
    ...
    /**
     * Adds a single {@link SimpleSlashCommand SimpleCommand} to this CommandClient's
     * registered SimpleCommand.
     *
     * <p>For CommandClient's containing 20 commands or less, command calls by users will have the bot iterate
     * through the entire {@link java.util.ArrayList ArrayList} to find the command called. As expected, this
     * can get fairly hefty if a bot has a lot of Commands registered to it.
     ...
     * are located at in the ArrayList they are stored.
     *
     * <p>This means that all insertion and removal of SimpleCommands must reorganize the index maintained by the HashMap.
     * <br>For this particular insertion, the SimpleCommand provided is inserted at the end of the index, meaning it will
     * become the "rightmost" Command in the ArrayList.
     *
     * @param  command
     *         The Command to add
     *
     * @throws java.lang.IllegalArgumentException
     *         If the SimpleCommand provided has a name or alias that has already been registered
     */
    void addSimpleCommand(SimpleSlashCommand command);
     ...
     *         If the Command provided has a name or alias that has already been registered to an index
     */
    void addSimpleCommand(SimpleSlashCommand command, int index);
     ...
     * com.greazi.discordbotfoundation.commands.annotation.JDACommand.Module JDACommand.Module} into a {@link java.util.List
    ...
    /**
     * Sets the {@link com.greazi.discordbotfoundation.commands.CommandListener CommandListener} to catch
     * command-related events thrown by this {@link com.greazi.discordbotfoundation.commands.CommandClient CommandClient}.
     * 
     * @param  listener
     *         The CommandListener
     */
    ...
    /**
     * Returns the current {@link com.greazi.discordbotfoundation.commands.CommandListener CommandListener}.
     * 
    ...
    /**
     * Returns the list of registered {@link SimpleSlashCommand SimpleCommand}s
     * during this session.
     *
     * @return A never-null List of Slash Commands registered during this session
     */
    List<SimpleSlashCommand> getSimpleCommands();
    ...
    /**
     * Gets the time this {@link com.greazi.discordbotfoundation.commands.CommandClient CommandClient}
     ...
     *
     * <p>This is used for methods such as {@link com.greazi.discordbotfoundation.commands.CommandEvent#async(Runnable)
     ...
     *
     * @see    com.greazi.discordbotfoundation.commands.CommandClientBuilder#setLinkedCacheSize(int)
     ...
     * {@link com.greazi.discordbotfoundation.commands.GuildSettingsManager GuildSettingsManager} to
     * {@link com.greazi.discordbotfoundation.commands.CommandClientBuilder#setGuildSettingsManager(com.greazi.discordbotfoundation.commands.GuildSettingsManager)
     ...
     *         {@link com.greazi.discordbotfoundation.commands.GuildSettingsManager#getSettings(Guild)
    ...
    /**
     * Returns the type of {@link com.greazi.discordbotfoundation.commands.GuildSettingsManager GuildSettingsManager},
