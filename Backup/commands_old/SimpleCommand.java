...
/**
 * <h1><b>Commands In </b></h1>
 * 
 * <p>The internal inheritance for Commands used in  is that of the Command object.
 * 
 ...
 * {@link SimpleCommand#execute(com.greazi.discordbotfoundation.commands.CommandEvent) #execute(CommandEvent)} body:
 * 
 ...
 * {@link com.greazi.discordbotfoundation.commands.CommandEvent CommandEvent} and is performed in two steps:
 * <ul>
 ...
 *     
 *     <li>{@link SimpleCommand#execute(CommandEvent) execute} - The command,
...
public abstract class SimpleCommand
{
    ...
    /**
     * The {@link SimpleCommand.Category Category} of the command.
     ...
     * @see SimpleSlashCommand#options
     */
     ...
     * If enabled for a Slash Command, only owners (owner + up to 9 co-owners) will be added to the SimpleCommand.
     ...
     * {@link SimpleCommand#name Command.name}.
     ...
     * <child name>}.
     */
    protected SimpleCommand[] children = new SimpleCommand[0];
     ...
     */
    protected BiConsumer<CommandEvent, SimpleCommand> helpBiConsumer = null;
     ...
     * <br>Default {@link SimpleCommand.CooldownScope#USER CooldownScope.USER}.
     */
     ...
     * 
     * @param  event
     *         The {@link com.greazi.discordbotfoundation.commands.CommandEvent CommandEvent} that
     ...
     * given {@link com.greazi.discordbotfoundation.commands.CommandEvent CommandEvent} that called it.
    ...
    public final void run(CommandEvent event)
    {
        ...
        if(!event.getArgs().isEmpty())
        {
            ...
            for(SimpleCommand cmd: getChildren())
            {
     ...
     *
     * <p>{-{@link SimpleCommand#name name}},
     * {-{@link SimpleCommand.Category category name}}, or {-{@code all}}
     ...
     * <br>Also note that setting {@link SimpleCommand#usesTopicTags usesTopicTags}
    ...
    /**
     * Gets the {@link SimpleCommand#name Command.name} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#help Command.help} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#category Command.category} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#arguments Command.arguments} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#requiredRole Command.requiredRole} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#cooldown Command.cooldown} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#userPermissions Command.userPermissions} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#botPermissions Command.botPermissions} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#aliases Command.aliases} for the Command.
     *
    ...
    /**
     * Gets the {@link SimpleCommand#children Command.children} for the Command.
     *
     * @return The children for the Command
     */
    public SimpleCommand[] getChildren()
    {
        return children;
    }
     ...
     * {@link com.greazi.discordbotfoundation.commands.CommandEvent CommandEvent}.
     *
     * @param  event
     ...
     * {@link com.greazi.discordbotfoundation.commands.CommandEvent CommanEvent}.
     *
     * @param  event
     ...
     * {@link com.greazi.discordbotfoundation.commands.CommandEvent CommandEvent} doesn't meet
    ...
    public static class Category
    {
         ...
         * {@link SimpleCommand.Category#test(com.greazi.discordbotfoundation.commands.CommandEvent)}
         * returns {@code false}.
         * 
         * @param  name 
         *         The name of the Category
         ...
         * 
         * @param  event
         *         The {@link com.greazi.discordbotfoundation.commands.CommandEvent CommandEvent}
     ...
     * {@link SimpleCommand Command}'s cooldown.
     *
     ...
     * <ul>
     *     <li>{@link SimpleCommand.CooldownScope#GUILD GUILD} defaults to
     *     {@link SimpleCommand.CooldownScope#CHANNEL CHANNEL}.</li>
     *     <li>{@link SimpleCommand.CooldownScope#USER_GUILD USER_GUILD} defaults to
     *     {@link SimpleCommand.CooldownScope#USER_CHANNEL USER_CHANNEL}.</li>
     * </ul>
     *
     ...
     * and/or via some external system unrelated to .
     *
     * @since  1.3
    ...
    public enum CooldownScope
    {
         ...
         * </ul>
         *
         * <p><b>NOTE:</b> This will automatically default back to {@link SimpleCommand.CooldownScope#CHANNEL CooldownScope.CHANNEL}
         ...
         * </ul>
         *
         * <p><b>NOTE:</b> This will automatically default back to {@link SimpleCommand.CooldownScope#GLOBAL CooldownScope.GLOBAL}
         ...
         * </ul>
         *
         * <p><b>NOTE:</b> This will automatically default back to {@link SimpleCommand.CooldownScope#USER CooldownScope.USER}
         * when {@link net.dv8tion.jda.api.JDA#getShardInfo() JDA#getShardInfo()} returns {@code null}.
         * This is done in order to prevent internal {@link java.lang.NullPointerException NullPointerException}s
         * from being thrown while generating cooldown keys!
         */
