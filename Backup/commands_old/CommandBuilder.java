...
/**
 * A chain-setter based builder for {@link SimpleCommand Commands}.
 *
 ...
 * {@link com.greazi.discordbotfoundation.commands.CommandClient#addCommand(SimpleCommand)
...
public class CommandBuilder
{
    ...
    private final LinkedList<SimpleCommand> children = new LinkedList<>();
    private BiConsumer<CommandEvent, SimpleCommand> helpBiConsumer = null;
    private boolean usesTopicTags = true;
    private CooldownScope cooldownScope = CooldownScope.USER;
    private boolean hidden = false;

    /**
     * Sets the {@link SimpleCommand#name name}
    ...
    /**
     * Sets the {@link SimpleCommand#help help}
    ...
    /**
     * Sets the {@link SimpleCommand#category category}
     * of the Command built from this CommandBuilder.
     *
     * @param  category
    ...
    /**
     * Sets the {@link SimpleCommand#arguments arguments}
     * of the Command built from this CommandBuilder.
     *
     * @param  arguments
    ...
    /**
     * Sets the Command built to be {@link SimpleCommand#guildOnly
     * guild only}.
     *
     * @param  guildOnly
    ...
    /**
     * Sets the name of a {@link SimpleCommand#requiredRole
    ...
    /**
     * Sets the Command built to be {@link SimpleCommand#ownerCommand
     * owner only}.
     *
     * @param  ownerCommand
    ...
    /**
     * Sets the {@link SimpleCommand#cooldown cooldown}
     * of the Command built from this CommandBuilder.
     *
     * @param  cooldown
    ...
    /**
     * Sets the {@link SimpleCommand#userPermissions
    ...
    /**
     * Sets the {@link SimpleCommand#botPermissions
    ...
    /**
     * Adds a {@link SimpleCommand#aliases alias}
    ...
    /**
     * Adds {@link SimpleCommand#aliases aliases}
     * for the Command built from this CommandBuilder.
     *
     * @param  aliases
    ...
    /**
     * Sets the {@link SimpleCommand#aliases aliases}
     * of the Command built from this CommandBuilder.
     *
     * @param  aliases
    ...
    /**
     * Adds a {@link SimpleCommand#children child}
     ...
     * @return This CommandBuilder.
     */
    public CommandBuilder addChild(SimpleCommand child)
    {
        children.add(child);
        return this;
    }
    ...
    /**
     * Adds {@link SimpleCommand#children child}
     ...
     * @return This CommandBuilder.
     */
    public CommandBuilder addChildren(SimpleCommand... children)
    {
        for(SimpleCommand child : children)
            addChild(child);
        return this;
    }

    /**
     * Sets the {@link SimpleCommand#children children}
     * of the Command built from this CommandBuilder.
     *
     * @param  children
     ...
     * @return This CommandBuilder
     */
    public CommandBuilder setChildren(SimpleCommand... children)
    {
        this.children.clear();
        if(children!=null)
            for(SimpleCommand child : children)
     ...
     * @return This CommandBuilder
     */
    public CommandBuilder setChildren(Collection<SimpleCommand> children)
    {
        this.children.clear();
        if(children != null)
    ...
    /**
     * Sets the {@link SimpleCommand#helpBiConsumer
     ...
     * @return This CommandBuilder
     */
    public CommandBuilder setHelpBiConsumer(BiConsumer<CommandEvent, SimpleCommand> helpBiConsumer)
    {
    ...
    /**
     * Sets the Command built to {@link SimpleCommand#usesTopicTags
     * use TopicTags}.
     *
     * @param  usesTopicTags
    ...
    /**
     * Sets the {@link SimpleCommand#cooldownScope
    ...
    /**
     * Sets the Command built to be {@link SimpleCommand#hidden hidden}
     ...
     *
     * <p>This uses the only the {@link com.greazi.discordbotfoundation.commands.CommandEvent
     ...
     *
     * <p>An alternate method {@link com.greazi.discordbotfoundation.commands.CommandBuilder#build(java.util.function.BiConsumer)} exists if you wish to retrieve information
     ...
     */
    public SimpleCommand build(Consumer<CommandEvent> execution)
    {
     ...
     * using the previously provided information.
     *
     * <p>This uses the both the {@link com.greazi.discordbotfoundation.commands.CommandEvent
     * CommandEvent} parameter that would be provided during
     * {@link SimpleCommand#execute(CommandEvent) #execute(CommandEvent)},
     * and the Command built when, allowing info on the Command to be retrieved during execution.
     *
     * @param  execution
     *         The {@link java.util.function.BiConsumer} that runs on  {@link SimpleCommand#execute(CommandEvent)}.
     *
     * @return The Command built
     */
    public SimpleCommand build(BiConsumer<SimpleCommand,CommandEvent> execution)
    {
        return new BlankSimpleCommand(name, help, category, arguments,
                guildOnly, requiredRole, ownerCommand, cooldown,
                userPermissions, botPermissions, aliases.toArray(new String[aliases.size()]),
                children.toArray(new SimpleCommand[children.size()]), helpBiConsumer, usesTopicTags,
    ...
    private abstract class BlankSimpleCommand extends SimpleCommand
    {
        BlankSimpleCommand(String name, String help, Category category,
                           String arguments, boolean guildOnly, String requiredRole,
                           boolean ownerCommand, int cooldown, Permission[] userPermissions,
                           Permission[] botPermissions, String[] aliases, SimpleCommand[] children,
                           BiConsumer<CommandEvent, SimpleCommand> helpBiConsumer,
