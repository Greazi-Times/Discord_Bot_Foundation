...
public class CommandClientBuilder
{
    ...
    private final LinkedList<SimpleSlashCommand> simpleSlashCommands = new LinkedList<>();
    ...
    public CommandClient build()
    {
        CommandClient client = new CommandClientImpl(ownerId, coOwnerIds, prefix, altprefix, prefixes, prefixFunction, commandPreProcessFunction, commandPreProcessBiFunction, activity, status, serverInvite,
                                                     success, warning, error, carbonKey, botsKey, new ArrayList<>(simpleCommands), new ArrayList<>(simpleSlashCommands), new ArrayList<>(contextMenus), forcedGuildId, manualUpsert, useHelp,
    ...
    {
        simpleSlashCommands.add(command);
        return this;
    }
