package com.greazi.old;

import com.greazi.old.command.general.PingCommand;
import com.greazi.old.console.ClearConsoleCommand;
import com.greazi.old.console.HelpConsoleCommand;
import com.greazi.old.console.StopConsoleCommand;
import com.greazi.old.constants.Constants;
import com.greazi.old.debug.Debugger;
import com.greazi.old.handlers.buttons.ButtonHandler;
import com.greazi.old.handlers.buttons.SimpleButton;
import com.greazi.old.handlers.commands.SimpleSlashCommand;
import com.greazi.old.handlers.commands.SlashCommandHandler;
import com.greazi.old.handlers.console.ConsoleCommandHandler;
import com.greazi.old.handlers.console.SimpleConsoleCommand;
import com.greazi.old.handlers.crons.CronHandler;
import com.greazi.old.handlers.modals.ModalHandler;
import com.greazi.old.handlers.modals.SimpleModal;
import com.greazi.old.handlers.selectmenu.entity.EntitySelectMenuHandler;
import com.greazi.old.handlers.selectmenu.string.SimpleStringSelectMenu;
import com.greazi.old.handlers.selectmenu.string.StringSelectMenuHandler;
...
public abstract class SimpleBot {
     ...
     * .
     * <p>
     * You can override this in your own
    ...
    public SimpleBot() {
        ...
        // Set up the managers for the bot
        setupManagers();

        registerCommands(
                new PingCommand().getCommandData()
        );
    ...
    private void registerCommands(final CommandData... commands) {
        getJDA().updateCommands().addCommands(commands).queue();
    }
    ...
    private void setMainGuild(final JDA jda) {
        final long mainGuildId = SimpleSettings.Bot.MainGuild();

        Valid.checkBoolean(mainGuildId != 0L, "You need to set the main guild ID in the config file!");
