 ...
 */
package com.greazi.discordbotfoundation.utils.expiringmap;
...
public final class ExpiringMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public static final class Builder<K, V> {
         ...
         */
        public <K1 extends K, V1 extends V> Builder<K1, V1> entryLoader(@NonNull final EntryLoader<? super K1, ? super V1> loader) {
