 ...
 * <ul>
 *     <li>{@link SimpleSlashCommand#run(SlashCommandEvent, CommandClient) run} - The command runs
...
public abstract class SimpleSlashCommand extends SimpleCommand
{
     ...
     */
    protected com.greazi.discordbotfoundation.commands.CommandClient client;

    /**
     * The main body method of a {@link SimpleSlashCommand SimpleCommand}.
     * <br>This is the "response" for a successful
     * {@link SimpleSlashCommand#run(SlashCommandEvent, CommandClient) #run(CommandEvent)}.
     *
     * @param  event
     ...
     * <b>
     *     Because this is a SimpleCommand, this is called, but does nothing.
     ...
     */
    @Override
    protected void execute(com.greazi.discordbotfoundation.commands.CommandEvent event) {}

    /**
     * Runs checks for the {@link SimpleSlashCommand SimpleCommand} with the
     ...
     */
    public final void run(SlashCommandEvent event, com.greazi.discordbotfoundation.commands.CommandClient client)
    {
        // set the client
        this.client = client;
     ...
     */
    public com.greazi.discordbotfoundation.commands.CommandClient getClient()
    {
        return client;
    }
    ...
    /**
     * Builds CommandData for the SimpleCommand upsert.
    ...
    /**
     * Builds CommandPrivilege for the SimpleCommand permissions.
     ...
     */
    public List<CommandPrivilege> buildPrivileges(@Nullable com.greazi.discordbotfoundation.commands.CommandClient client)
    {
    ...
    private void terminate(SlashCommandEvent event, String message, com.greazi.discordbotfoundation.commands.CommandClient client)
    {
        if(message!=null)
     ...
     *         else {@code null}.
     */
    public String getCooldownError(SlashCommandEvent event, int remaining, com.greazi.discordbotfoundation.commands.CommandClient client)
    {
        if(remaining<=0)
            return null;
