...
public abstract class SimpleSelectMenu {
	 ...
	 */
	public SimpleSelectMenu(final String menu_id) {
	 ...
	 */
	public SimpleSelectMenu placeholder(final String placeholder) {
	 ...
	 */
	public SimpleSelectMenu min(final int min) {
		this.min = min;
		return this;
	}
	 ...
	 */
	public SimpleSelectMenu max(final int max) {
		this.max = max;
		return this;
	}
	 ...
	 */
	public SimpleSelectMenu minMax(final int min, final int max) {
		this.min = min;
		this.max = max;
		return this;
	}
	 ...
	 * @return The same builder instance for chaining
	 */
	public SimpleSelectMenu disabled(final boolean disabled) {
	 ...
	 */
	public SimpleSelectMenu options(final SelectOption... options) {
	 ...
	 * @throws IllegalArgumentException If the total amount of options is greater than 25 or null is provided
	 */
	public SimpleSelectMenu options(final List<SelectOption> options) {
	 ...
	 */
	public SimpleSelectMenu option(final String label, final String value, final boolean selected) {
	 ...
	 *                                  or any of the individual parameter requirements are violated.
	 */
	public SimpleSelectMenu option(final String label, final String value, final String description, final boolean selected) {
		final SelectOption option = SelectOption.of(label, value)
	 ...
	 *                                  or any of the individual parameter requirements are violated.
	 */
	public SimpleSelectMenu option(final String label, final String value, final Emoji emoji, final boolean selected) {
		final SelectOption option = SelectOption.of(label, value)
				.withEmoji(emoji)
				.withDefault(selected);
		this.options.add(option);
	 ...
	 *                                  or any of the individual parameter requirements are violated.
	 */
	public SimpleSelectMenu option(final String label, final String value, final String description, final Emoji emoji, final boolean selected) {
		final SelectOption option = SelectOption.of(label, value)
				.withDescription(description)
				.withEmoji(emoji)
				.withDefault(selected);
	...
	public SelectMenu build() {
		final SelectMenu.Builder builder = SelectMenu.create(this.menu_id);
