package com.greazi.discordbotfoundation.mysql.utils;
...
public class TableBuilder {
    ...
    public String build() {
        ...
        final boolean headersPresent = headers != null;
        final boolean rowNamesPresent = rowNames != null;
        ...
        if (autoAdjust) {
            ...
            final int[] maxLengths = new int[columns];
            ...
            for (final String[] row : values) {
                for (int j = 0; j < row.length; j++) {
                    ...
                    final int adjustment = maxLengths[j] - value.length();
        ...
        final String[] firstRow = values[0];
    ...
    private void appendRow(final StringBuilder builder, final String[] row) {
        if (frame)
    ...
    private void setAlignment(final int adjustment, final String oldValue, final StringBuilder newValueBuilder) {
        ...
        switch (alignment) {
            ...
            case LEFT:
                ...
                break;
            case CENTER:
                final boolean even = adjustment % 2 == 0;
                final int half = adjustment / 2;
     ...
     * @return this
     */
    public TableBuilder addHeaders(final String... headers) {
     ...
     */
    public TableBuilder addRowNames(final String... rows) {
        this.rowNames = rows;
        return this;
    }
     ...
     * @return This builder.
     */
    public TableBuilder setValues(final String[][] values) {
        this.values = values;
        return this;
    }
     ...
     * @return This builder.
     */
    public TableBuilder setBorders(final Borders borders) {
     ...
     */
    public TableBuilder setName(final String tableName) {
     ...
     * @see Alignment
     */
    public TableBuilder setAlignment(final Alignment alignment) {
     ...
     * @see TableBuilder#autoAdjust(boolean)
     */
    public TableBuilder setPadding(final int padding) {
     ...
     * @return This builder.
     */
    public TableBuilder codeblock(final boolean codeblock) {
     ...
     * @return This builder.
     */
    public TableBuilder frame(final boolean frame) {
        this.frame = frame;
        return this;
    }
     ...
     * @return This builder.
     */
    public TableBuilder autoAdjust(final boolean autoAdjust) {
    ...
    public static class Borders {
        ...
        private Borders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String leftIntersection,
                        final String rightIntersection, final String upperIntersection, final String lowerIntersection, final String upLeftCorner,
                        final String upRightCorner, final String lowLeftCorner, final String lowRightCorner, final String headerDelimiter,
                        final String headerCrossDelimiter, final String headerLeftIntersection, final String headerRightIntersection,
                        final String firstColumnDelimiter, final String firstColumnCrossDelimiter, final String firstColumnUpperIntersection,
                        final String firstColumnLowerIntersection, final String headerColumnCrossDelimiter, final String horizontalOutline, final String verticalOutline) {
        ...
        // framing + headers
        private Borders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String leftIntersection, final String rightIntersection,
                        final String upperIntersection, final String lowerIntersection, final String upLeftCorner, final String upRightCorner, final String lowLeftCorner,
                        final String lowRightCorner, final String headerDelimiter, final String headerCrossDelimiter, final String headerLeftIntersection,
                        final String headerRightIntersection, final String horizontalOutline, final String verticalOutline) {
        ...
        private Borders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String leftIntersection, final String rightIntersection,
                        final String upperIntersection, final String lowerIntersection, final String upLeftCorner, final String upRightCorner, final String lowLeftCorner,
                        final String lowRightCorner, final String horizontalOutline, final String verticalOutline) {
            this(rowDelimiter, columnDelimiter, crossDelimiter, leftIntersection, rightIntersection, upperIntersection, lowerIntersection,
        ...
        // plain + headers + rows
        private Borders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String headerDelimiter, final String headerCrossDelimiter,
                        final String firstColumnDelimiter, final String firstColumnCrossDelimiter, final String headerColumnCrossDelimiter) {
        ...
        // plain
        private Borders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter) {
         ...
         */
        public static Borders newHeaderRowNamesFrameBorders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String leftIntersection,
                                                            final String rightIntersection, final String upperIntersection, final String lowerIntersection, final String upLeftCorner,
                                                            final String upRightCorner, final String lowLeftCorner, final String lowRightCorner, final String headerDelimiter,
                                                            final String headerCrossDelimiter, final String headerLeftIntersection, final String headerRightIntersection,
                                                            final String firstColumnDelimiter, final String firstColumnCrossDelimiter, final String firstColumnUpperIntersection,
         ...
         * @return Borders instance
         */
        public static Borders newHeaderFrameBorders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String leftIntersection, final String rightIntersection,
                                                    final String upperIntersection, final String lowerIntersection, final String upLeftCorner, final String upRightCorner, final String lowLeftCorner,
                                                    final String lowRightCorner, final String headerDelimiter, final String headerCrossDelimiter, final String headerLeftIntersection,
                                                    final String headerRightIntersection, final String horizontalOutline, final String verticalOutline) {
         ...
         * @return Borders instance
         */
        public static Borders newFrameBorders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String leftIntersection, final String rightIntersection,
                                              final String upperIntersection, final String lowerIntersection, final String upLeftCorner, final String upRightCorner, final String lowLeftCorner,
                                              final String lowRightCorner, final String horizontalOutline, final String verticalOutline) {
         ...
         * @return Borders instance
         */
        public static Borders newHeaderRowNamesPlainBorders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String headerDelimiter, final String headerCrossDelimiter,
                                                            final String firstColumnDelimiter, final String firstColumnCrossDelimiter, final String headerColumnCrossDelimiter) {
         ...
         * @return Borders instance
         */
        public static Borders newHeaderPlainBorders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter, final String headerDelimiter, final String headerCrossDelimiter) {
         ...
         * @return Borders instance
         */
        public static Borders newPlainBorders(final String rowDelimiter, final String columnDelimiter, final String crossDelimiter) {
