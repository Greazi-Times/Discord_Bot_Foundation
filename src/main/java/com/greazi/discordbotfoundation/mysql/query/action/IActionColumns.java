...
import com.greazi.discordbotfoundation.mysql.query.column.Integer;
...
public interface IActionColumns {
	 ...
	 */
	com.greazi.discordbotfoundation.mysql.query.column.String string(String name);
	 ...
	 * @return String column object.
	 */
	com.greazi.discordbotfoundation.mysql.query.column.String string(String name, java.lang.Integer length);
	 ...
	 */
	Base column(String name, String content);
}
