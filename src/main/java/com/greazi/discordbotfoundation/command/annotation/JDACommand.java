...
public @interface JDACommand
{
     ...
     * {@link SimpleCommand#getCooldown() Command#cooldown}
     * and {@link SimpleCommand#getCooldownScope() Command#cooldownScope}.
     *
    ...
    /**
     * A value wrapper for what would be {@link SimpleCommand#getCooldown() Command#cooldown}
     * and {@link SimpleCommand#getCooldownScope() Command#cooldownScope}.
     *
